...
export default function Home() {
    ...
    const tableParams = { thead: ['Cliente', 'Vendedor', 'Produto'] }
                ...
                <>
                    ...
                    {Object.keys(userData).length > 0 ?
                        <div style={{ marginTop: '48px'}}>
                            <Text small={true} title="Histórico de vendas" />
                            <Table general={ true } url="general" tableData={userData['sells']} type="equipe" tableParams={tableParams} />
                        </div>
                        : ''}
                </>
                }
